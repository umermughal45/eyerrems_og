...
export function AddClientDialog({
  ...
  const handleSubmit = async (event?: React.FormEvent<HTMLFormElement> | React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      // NOTE: tid is NOT sent from frontend — it is auto-generated by the backend
            ...
            <TabsContent value="basic" className="space-y-4">
              <div className="grid gap-4 md:grid-cols-3">
                <div className="grid gap-2">
                  <Label htmlFor="systemId">Client ID (Auto-generated)</Label>
                  <Input
                    id="systemId"
                    value={formData.systemId || (isEdit ? "Loading..." : "Will be generated on save (e.g. CLI-0001)")}
                    disabled
                    className="bg-muted text-muted-foreground font-mono"
                    placeholder="CLI-0001"
                  />
                  <p className="text-xs text-muted-foreground">Auto-generated unique client identifier</p>
                </div>
                ...
                <div className="grid gap-2">
                  <Label htmlFor="client-tid">TID (Auto-generated)</Label>
                  <Input
                    id="client-tid"
                    value={formData.tid || (isEdit ? "Loading..." : "Will be generated on save (e.g. TRX-2026-000001)")}
                    disabled
                    className="bg-muted text-muted-foreground font-mono"
                    placeholder="TRX-2026-000001"
                  />
                  <p className="text-xs text-muted-foreground">Master transaction ID — auto-assigned by system</p>
                </div>
                <div className="grid gap-2">
