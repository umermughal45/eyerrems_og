            ...
            <TabsContent value="basic" className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="grid gap-2">
                  <Label htmlFor="systemId">Lead ID (Auto-generated)</Label>
                  <Input
                    id="systemId"
                    value={formData.systemId || (isEdit ? "Loading..." : "Will be generated on save (e.g. LD-0001)")}
                    disabled
                    className="bg-muted text-muted-foreground font-mono"
                    placeholder="LD-0001"
                  />
                  <p className="text-xs text-muted-foreground">Auto-generated unique lead identifier</p>
                </div>
                <div className="grid gap-2">
                  <Label htmlFor="tid">TID (Auto-generated)</Label>
                  <Input
                    id="tid"
