...
async function runVerification() {
    ...
    try {
        ...
        const tid = await transactionIdentity_service_1.TransactionIdentityEngine.generateTransactionID();
        ...
        await transactionIdentity_service_1.TransactionIdentityEngine.attachTid(tid, 'lead', lead.id, 'CRM');
        ...
        await transactionIdentity_service_1.TransactionIdentityEngine.attachTid(client.tid, 'client', client.id, 'CRM');
        ...
        await transactionIdentity_service_1.TransactionIdentityEngine.attachTid(deal.tid, 'deal', deal.id, 'Properties');
...
runVerification();
//# sourceMappingURL=verify-lifecycle.js.map