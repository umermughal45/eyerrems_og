...
async function generateFinancialReportExcel(reportData, reportType, res) {
...
async function generateTrialBalanceExcel(worksheet, data) {
    // Header
...
async function generateBalanceSheetExcel(worksheet, data) {
    // Header
    ...
    const currentAssetsTotal = data.assets.current.reduce((sum, e) => sum + e.balance, 0);
    ...
    const fixedAssetsTotal = data.assets.fixed.reduce((sum, e) => sum + e.balance, 0);
    ...
    const liabilitiesTotal = data.liabilities.current.reduce((sum, e) => sum + Math.abs(e.balance), 0);
...
async function generateProfitLossExcel(worksheet, data) {
    // Header
...
async function generatePropertyProfitabilityExcel(worksheet, data) {
...
async function generateEscrowExcel(worksheet, data) {
    // Header
...
async function generateAgingExcel(worksheet, data) {
    // Header
...
async function addFraudDetectionSheet(workbook, reportData) {
    try {
        ...
        logger_1.default.warn('Failed to add fraud detection sheet:', error);
    }
}
//# sourceMappingURL=financial-report-excel.js.map