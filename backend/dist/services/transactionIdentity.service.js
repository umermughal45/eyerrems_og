...
exports.TransactionIdentityEngine = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
class TransactionIdentityEngine {
    /**
     ...
     */
    static async attachTid(tid, entityType, entityId, moduleName) {
     ...
     */
    static async getTidForEntity(entityType, entityId) {
...
exports.TransactionIdentityEngine = TransactionIdentityEngine;
//# sourceMappingURL=transactionIdentity.service.js.map