...
exports.AttendanceStateService = void 0;
...
class AttendanceStateService {
     ...
     */
    static getAttendanceState(attendance) {
        if (!attendance) {
            return 'NOT_STARTED';
        }
     ...
     */
    static async validateDutyTimeWindow(employeeId, checkInTime, shiftId) {
     ...
     */
    static async getAttendanceStateForDate(employeeId, date) {
...
exports.AttendanceStateService = AttendanceStateService;
//# sourceMappingURL=attendance-state-service.js.map