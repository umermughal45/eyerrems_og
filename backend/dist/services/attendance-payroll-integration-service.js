...
exports.AttendancePayrollIntegrationService = void 0;
const client_1 = __importDefault(require("../prisma/client"));
class AttendancePayrollIntegrationService {
    /**
     * Calculate attendance-based deductions and allowances for payroll
     */
    static async calculateAttendanceBasedPayroll(options) {
        const { employeeId, month, baseSalary, absentDeductionRate, lateDeductionRate, halfDayDeductionRate, overtimeHourlyRate, standardWorkingHours = 8, standardWorkingDays, includeLeaveDays = false, } = options;
     ...
     */
    static async getAttendanceSummaryForMonth(employeeId, month) {
        const [year, monthNum] = month.split('-').map(Number);
        const startDate = new Date(year, monthNum - 1, 1);
...
exports.AttendancePayrollIntegrationService = AttendancePayrollIntegrationService;
//# sourceMappingURL=attendance-payroll-integration-service.js.map