    ...
    async processQuery(query) {
        ...
        try {
            ...
            if (insights.length === 0) {
                return {
                    insights: [
                        (0, types_1.createInsufficientDataInsight)('AI Assistant Query', this.getDataSources()),
                    ],
            ...
            logger_1.default.error(`AI Assistant Engine error: ${error.message}`, error);
            errors.push(error.message);
            insights.push((0, types_1.createErrorInsight)('AI Assistant', error.message, this.getDataSources()));
        }
        return {
            insights,
            engine_name: this.name,
...
//# sourceMappingURL=ai-assistant-engine.js.map