...
exports.calculateDelayProbability = calculateDelayProbability;
/**
 ...
 */
function calculateChurnProbability(params) {
    const { paymentDelays, totalPayments, daysUntilLeaseExpiry, paymentConsistency, satisfactionScore, minDataPoints = 3, minConfidence = 70, } = params;
    ...
    const weightedProbability = factors.reduce((sum, f) => sum + f.impact * f.weight, 0);
 ...
 * - Budget utilization
 */
function calculateDelayProbability(params) {
    const { expectedProgress, actualProgress, daysElapsed, totalDays, budgetUtilization, historicalDelays = 0, minConfidence = 70, } = params;
    // PRODUCTION RULE: ML must enforce refusal conditions
...
//# sourceMappingURL=probability-models.js.map