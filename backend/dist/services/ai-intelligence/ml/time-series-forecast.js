 ...
 */
function forecastTimeSeries(values, periods = 1, minDataPoints = 6, minConfidence = 70) {
 ...
 */
function calculateDataQuality(values, hasVariation, hasOutliers) {
    let score = 100;
...
//# sourceMappingURL=time-series-forecast.js.map