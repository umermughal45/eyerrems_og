...
exports.getSheetConfigs = getSheetConfigs;
    ...
    return [
        {
            ...
            query: () => client_1.default.property.findMany({ where: { isDeleted: false } }),
        },
        {
            name: 'Customers',
            model: 'Client',
            ...
            query: () => client_1.default.client.findMany({ where: { isDeleted: false } }),
        },
        {
            name: 'Installments',
            ...
            query: () => client_1.default.saleInstallment.findMany({ where: { isDeleted: false } }),
        },
        {
            name: 'Payments',
            model: 'Payment',
            ...
            query: () => client_1.default.payment.findMany(),
        },
        {
            name: 'Ledger',
            model: 'LedgerEntry',
            ...
            query: () => client_1.default.ledgerEntry.findMany(),
        },
        {
            name: 'Staff',
            model: 'Employee',
            ...
            query: () => client_1.default.employee.findMany({ where: { isDeleted: false } }),
        },
        {
            name: 'Leads',
            model: 'Lead',
            ...
            query: () => client_1.default.lead.findMany({ where: { isDeleted: false } }),
        },
        {
            name: 'Bookings',
            model: 'Deal',
            ...
            query: () => client_1.default.deal.findMany({ where: { isDeleted: false } }),
        },
    ];
}
