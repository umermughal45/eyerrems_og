...
exports.VoucherAccountingSafetyService = void 0;
const client_1 = __importDefault(require("../prisma/client"));
class VoucherAccountingSafetyService {
    /**
     * Validate financial period is open for posting
     * Prevents posting in closed/locked periods
     */
    static async validateFinancialPeriod(postingDate, tx) {
     ...
     */
    static async validateIdempotency(voucherId, tx) {
        const client = tx || client_1.default;
     ...
     */
    static async validateCashBalance(accountId, creditAmount, // Amount being credited (reducing cash)
    voucherDate, tx) {
        const client = tx || client_1.default;
        if (creditAmount <= 0) {
     ...
     */
    static async validateBankBalance(accountId, creditAmount, // Amount being credited (reducing bank)
    tx) {
        const client = tx || client_1.default;
        if (creditAmount <= 0) {
            return { valid: true };
     ...
     */
    static async validatePropertyUnitLinkage(type, propertyId, unitId, lines, tx) {
        const client = tx || client_1.default;
     ...
     */
    static async validateDuplicateReference(type, paymentMethod, referenceNumber, voucherId, tx) {
        const client = tx || client_1.default;
     ...
     */
    static async validateInvoiceAllocation(invoiceAllocations, totalAmount, tx) {
        const client = tx || client_1.default;
     ...
     */
    static validateLinesAndTotals(type, lines) {
     ...
     */
    static async validateJournalVoucherCashBank(lines, hasElevatedApproval, tx) {
        const client = tx || client_1.default;
...
exports.VoucherAccountingSafetyService = VoucherAccountingSafetyService;
//# sourceMappingURL=voucher-accounting-safety-service.js.map