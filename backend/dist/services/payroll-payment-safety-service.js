...
exports.PayrollPaymentSafetyService = void 0;
const client_1 = __importDefault(require("../prisma/client"));
class PayrollPaymentSafetyService {
    /**
     ...
     */
    static async validatePaymentMethodAccount(paymentMethod) {
        const normalizedMethod = paymentMethod.toLowerCase();
     ...
     */
    static async validateLedgerEntryStructure(salaryPayableAccountId, paymentAccountId, amount) {
        // Validate accounts exist
        const [payableAccount, paymentAccount] = await Promise.all([
            client_1.default.account.findUnique({ where: { id: salaryPayableAccountId } }),
            client_1.default.account.findUnique({ where: { id: paymentAccountId } }),
        ]);
        if (!payableAccount) {
            return {
                valid: false,
     ...
     */
    static async validatePaymentEdit(paymentId) {
     ...
     */
    static async validatePaymentDelete(paymentId) {
     ...
     * Block overpayments
     */
    static async validatePartialPayment(payrollId, paymentAmount) {
        const payroll = await client_1.default.payroll.findUnique({
            where: { id: payrollId },
            include: {
                payments: true,
     ...
     */
    static async calculateRemainingBalance(payrollId) {
        const payroll = await client_1.default.payroll.findUnique({
            where: { id: payrollId },
            include: {
                payments: true,
...
exports.PayrollPaymentSafetyService = PayrollPaymentSafetyService;
//# sourceMappingURL=payroll-payment-safety-service.js.map